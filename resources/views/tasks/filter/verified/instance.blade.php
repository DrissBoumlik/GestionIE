...
@section('content')
    ...
    <div class="content content-narrow">
        ...
        <div class="container-fluid">
            ...
            <div id="filter" class="filter d-none" data-filter="verified"></div>
            <div id="object_type" class="d-none" data-object_type="instance"></div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="refresh-form">
                                <button type="button" class="btn btn-primary historyPreview" data-type="Instance" data-toggle="modal" data-target="#modal-history">
